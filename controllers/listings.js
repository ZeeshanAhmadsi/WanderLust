...
newListing.owner = req.user._id;//used to store data of new owner who is creating its listing
...
if(!listing){
    req.flash("error","Edit listing does not exists");
    return res.redirect("/listings");
}
...
module.exports.updateListing = async(req,res)=>{
    ...
    req.flash("success","Successfully new listing updated");
